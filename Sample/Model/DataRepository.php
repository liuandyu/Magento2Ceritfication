...
use Krish\Sample\Api\DataRepositoryInterface;
use Krish\Sample\Api\Data\DataInterface;
use Krish\Sample\Api\Data\DataInterfaceFactory;
use Krish\Sample\Api\Data\DataSearchResultsInterfaceFactory;
use Krish\Sample\Model\ResourceModel\Data as ResourceData;
use Krish\Sample\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Krish\Sample\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Krish\Sample\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Krish\Sample\Model\ResourceModel\Data\Collection $collection */
